...
export default function AddPlayers() 
{
  ...
  const baseUrl=`https://64abc0e79edb4181202e7649.mockapi.io/gensokyoPeps`;
...
validationSchema: Yup.object({
  ...
  return (
      ...
      <h2 className='title' style={{borderColor:theme.borderColor}}>Add A New Girl Into Gensokyo</h2>
